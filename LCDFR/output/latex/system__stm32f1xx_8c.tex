\hypertarget{system__stm32f1xx_8c}{}\section{Core/\+Src/system\+\_\+stm32f1xx.c File Reference}
\label{system__stm32f1xx_8c}\index{Core/\+Src/system\+\_\+stm32f1xx.\+c@{Core/\+Src/system\+\_\+stm32f1xx.\+c}}
...
\item \hyperlink{group__STM32F1xx__System__Private__Functions_gae0c36a9591fe6e9c45ecb21a794f0f0f}{System\+Core\+Clock\+Update()}\+: Updates the variable System\+Core\+Clock and must be called whenever the core clock is changed during program execution.
\end{DoxyItemize}
\item After each device reset the H\+SI (8 M\+Hz) is used as system clock source. Then \hyperlink{group__STM32F1xx__System__Private__Functions_ga93f514700ccf00d08dbdcff7f1224eb2}{System\+Init()} function is called, in \char`\"{}startup\+\_\+stm32f1xx\+\_\+xx.\+s\char`\"{} file, to configure the system clock before to branch to main program.
